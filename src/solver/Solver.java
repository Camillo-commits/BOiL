...
import com.company.modules.Cycle;
import com.company.modules.Dostawca;
import com.company.modules.Odbiorca;
import com.company.modules.ZyskAndResult;

import java.util.LinkedList;
import java.util.List;

public class Solver {
    public static void solve(List<Dostawca> dostawcy, List <Odbiorca> odbiorcy,double[][] trasnport, ZyskAndResult[][] zysk, boolean first){
